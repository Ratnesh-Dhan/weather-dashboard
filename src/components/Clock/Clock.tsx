...
import useAudio from "../../hooks/clickAudio";
...
const Clock = ({ zone }) => {
  ...
  return (
    <div
      id="clock"
      className="m-20 rounded-[50%] w-[200px] h-[200px] shadow-[0_0_0_2px_rgb(255,255,255)] relative"
      style={{
    ...
    >
      {numbers.map((number, index) => (
        <div
          ...
          className="absolute"
          style={{
            transform: `translate(100px, 100px)  rotate(${
              index * 30 + 185
      ...
      <div
        ...
        style={{
          transform: `translate(95px, 30px) rotate(${
            hour * 30 + (30 / 360) * minute * 6
          }deg)`,
